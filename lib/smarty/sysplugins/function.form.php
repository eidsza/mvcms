<?PHP /* $Id: function.form.php,v 1.1.1.1 2002/09/13 17:52:11 darkelder Exp $ */
...
function smarty_function_form($parms,&$smarty)
{
    include_once SMARTY_DIR . 'plugins/shared.form.php';
    global $smarty_form;
    return $smarty_form->field_create("form",$parms);
}
