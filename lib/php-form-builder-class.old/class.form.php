...
class form extends pfbc { 
	...
	public function __construct($id = "myform") {
		...
		$this->allowedFields = array(
			...
			"text" => array("accept", "disabled", "maxlength", "minlength", "name", "readonly", "size", "type", "value", "accesskey", "class", "dir", "id", "lang", "style", "tabindex", "title", "xml:lang", "onblur", "onchange", "onclick", "ondblclick", "onfocus", "onmousedown", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onkeydown", "onkeypress", "onkeyup", "onselect"),
		...
		//$this->jsIncludesPath = '/mvcms/lib/php-form-builder-class/includes/';
...
STR;
		...
		if(empty($this->preventJQueryLoad))
			$str .= "\t\t<script type='text/javascript' src='$prefix://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js'></script>\n";
		if(empty($this->preventJQueryUILoad))
			$str .= "\t\t<script type='text/javascript' src='$prefix://ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/jquery-ui.min.js'></script>\n";
