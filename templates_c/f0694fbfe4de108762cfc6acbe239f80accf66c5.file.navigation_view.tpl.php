<?php /* Smarty version Smarty-3.1.11, created on 2013-03-12 08:58:24
         compiled from "F:\xampp\htdocs\mvcms\apps\admin\modules\navigation\view\navigation_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:58345107b076471f65-74911546%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f0694fbfe4de108762cfc6acbe239f80accf66c5' => 
    array (
  ...
  'nocache_hash' => '58345107b076471f65-74911546',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5107b07654ac47_04616554',
  'variables' => 
  array (
    'vars' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5107b07654ac47_04616554')) {function content_5107b07654ac47_04616554($_smarty_tpl) {?><link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['vars']->value['view_url'];?>
   ...
   //print_r($navigation); 
    ...
    if (count($navigatin_blocks) > 0){
        ...
        $form->addHTMLExternal('<div id="add-custom-form-locations" class="postbox">
          ...
          <div class="inside" style="display:'.( isset($_COOKIE['hidden_panel']['add-custom-form-locations']) ? $_COOKIE['hidden_panel']['add-custom-form-locations'] : 'none' ).'">
...
images/wpspin_light.gif" alt="" /></p>');
    ...
    //page block
        ...
        <div class="inside" style="display:'.(isset($_COOKIE['hidden_panel']['add-custom-form-pages']) ? $_COOKIE['hidden_panel']['add-custom-form-pages'] : 'none').'"><div class="customlinkdiv" id="customlinkdiv">
        ');
...
images/wpspin_light.gif" alt="" />');    
        ...
        <div class="inside"  style="display:'.(isset($_COOKIE['hidden_panel']['add-custom-form-links']) ? $_COOKIE['hidden_panel']['add-custom-form-links'] : 'none').'">
