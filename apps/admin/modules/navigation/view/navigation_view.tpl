<link rel="stylesheet" href="{$vars.view_url}css/navigation.css" type="text/css" media="all">
<div class="pageoverflow">
 <div class="pageheader">Budowanie menu </div>
   ...
   //print_r($navigation); 
    ...
    $form->addHTMLExternal('<p class="button-controls"><img class="waiting" src="{$vars.view_url}images/wpspin_light.gif" alt="" /></p>');
    ...
    //page block
        ...
        $form->addHTMLExternal('<p class="button-controls"><img class="waiting" src="{$vars.view_url}images/wpspin_light.gif" alt="" />');    
...
<script src="{$vars.view_url}js/jquery.ui.nestedSortable.js"></script>
<script src="{$vars.view_url}js/99-jquery.cookie.js"></script>
  {literal}
